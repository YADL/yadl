...
*/
int 
write_hash(char buff[],int fd_hash,int offset)
{
...
*/
int 
searchhash(char out[],int fd_hash)
{
...
*/
char* 
gethash(int fd_stub,int b_offset,int e_offset)
{
...
*/
int 
getposition(int fd_hash,char* hash)
{
