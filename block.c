...
Output:int
*/
int write_to_block(char buff[],size_t l,int fd_blk)
{
	int ret		=		-1;
...
Output:int
*/
int searchBlock(int fd_hash,int fd_blk,int fd_stub,int b_offset,int  e_offset)
{
	struct stat		st;
	int		size	=		0;
	size_t	length	=		0;
...
Output:char*
*/
char* getblock(int fd_blk,int pos)
{
	struct stat		st;
	int		size	=		0;
	size_t	length	=		0;
